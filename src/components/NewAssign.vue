  ...
  <div class="modal">
    <div class="modal-container">
      ...
      <div v-else="!data.isLoading" class="modal-content">
        ...
        <p>
          Seleccione un conductor y un vehiculo, no se pueden visualizar
          los vehiculos y conductores que ya han sido asignados.
        </p>
        <div>
          <select @change="handleOnVehicleChange">
            <option label="Seleccione un vehiculo" selected value="-1" />
            <option
        ...
        <div>
          <select @change="handleOnDriverChange">
            <option label="Seleccion un conductor" selected value="-1" />
            <option
